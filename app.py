...
def add_prediction(input_data):
    ...
    scaled_input_array = scalar.transform(input_array)
    ...
    if prediction[0] == 0:
        ...
        st.write( "<span style = 'color: red'>Malicious</span>", unsafe_allow_html=True)

    st.write("Probability of being benign: ", model.predict_proba(scaled_input_array)[0][0])
    st.write("Probability of being malicious: ", model.predict_proba(scaled_input_array)[0][1])
...
def scale_value(input_dict):
    ...
    for key, value in input_data.items():
        ...
        scale_dict[key] = scale_val
    return scale_dict

input_data = scale_value(input_dict)
with st.container():
